...
public class CustomCompoundBarcodeView extends FrameLayout {
    ...
    public CustomCompoundBarcodeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(attrs);
    }

    public CustomCompoundBarcodeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        viewFinder = (CustomViewfinderView) findViewById(R.id.zxing_viewfinder_view);

        if (viewFinder == null) {
            throw new IllegalArgumentException(
                    "There is no a com.journeyapps.barcodescanner.CustomViewfinderView on provided layout " +
    ...
    public void decodeSingle(BarcodeCallback callback) {
        barcodeView.decodeSingle(new CustomCompoundBarcodeView.WrappedCallback(callback));
    ...
    public void decodeContinuous(BarcodeCallback callback) {
        barcodeView.decodeContinuous(new CustomCompoundBarcodeView.WrappedCallback(callback));
    }
    ...
    public void setTorchListener(CompoundBarcodeView.TorchListener listener) {
