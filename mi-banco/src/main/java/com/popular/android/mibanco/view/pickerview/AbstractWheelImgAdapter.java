 ...
 */
public abstract class AbstractWheelImgAdapter extends AbstractWheelAdapter {

    /** Text view resource. Used as a default view for adapter. */
    public static final int IMG_VIEW_ITEM_RESOURCE = -1;
    ...
    protected int itemImgResourceId;
     ...
     */
    protected AbstractWheelImgAdapter(final Context context) {
     ...
     */
    protected AbstractWheelImgAdapter(final Context context, final int itemResource) {
     ...
     */
    protected AbstractWheelImgAdapter(final Context context, final int itemResource, final int itemImgResource) {
